...
export class Backend implements backendInterface {
    ...
    async addStudent(arg0: StudentInput): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deactivateStudent(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getResultsByExam(arg0: string): Promise<Array<Result>> {
        if (this.processError) {
            try {
    ...
    async getResultsByStudent(arg0: string): Promise<Array<Result>> {
        if (this.processError) {
            try {
    ...
    async submitAdmissionEnquiry(arg0: AdmissionEnquiry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAdmissionEnquiry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStudent(arg0: string, arg1: StudentInput): Promise<void> {
        if (this.processError) {
            try {
